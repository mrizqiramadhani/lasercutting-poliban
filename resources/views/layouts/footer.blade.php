<footer class="footer" style="margin-top: 75px; background-color: #212529; color: #ffffff">
    ...
    <div class="bg-dark py-4 py-md-5 py-xl-8 border-top border-darks-subtle">
        <div class="container overflow-hidden">
            <div class="row gy-4 gy-md-0 align-items-md-center">
                <div class="col-xs-12 col-md-7 order-1 order-md-0">
                    <div class="copyright text-center text-md-start">
                        &copy; Laser Cutting Poliban 2024. All Rights Reserved.
                    </div>
                </div>
            </div>
        </div>
