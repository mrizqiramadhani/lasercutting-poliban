...
<body>
    <div style="margin-bottom: 200px; padding-top: 100px">
        <div class="card border-warning mb-3">
            <div class="card-header"><img src="{{ asset('img/logo.jpg') }}" alt="">
                <h4 class="mt-3 mb-3">Laser Cutting Poliban</h4>
            </div>
            <div class="card-body">
                ...
                <p class="card-text mb-4">Jl. Brig Jend. Hasan Basri, Pangeran, Kec. Banjarmasin Utara, Kota
